...
class Bmv2SwitchConnection(SwitchConnection):
    def __init__(self, name, address='127.0.0.1:50051', device_id=0, type='bmv2', debug=False):
        super(Bmv2SwitchConnection, self).__init__(name, address, device_id, type, debug)
